...
function SidebarGroupContent({
  ...
  return (
    <div
      ...
      className={cn("w-full h-screen text-sm overflow-scroll", className)}
      {...props}
    />
  )
}
...
function SidebarMenu({ className, ...props }: React.ComponentProps<"ul">) {
  return (
    <ul
      ...
      data-sidebar="menu"
      className={cn("flex w-full h-screen min-w-0 flex-col pb-20", className)}
      {...props}
    />
  )
}
...
function SidebarMenuItem({ className, ...props }: React.ComponentProps<"li">) {
  return (
    <li
      ...
      className={cn("group/menu-item relative h-25 flex items-center hover:bg-gray-100", className)}
      {...props}
    />
  )
}
